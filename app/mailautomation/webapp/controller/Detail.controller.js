...
function (Controller, MessageToast, Input, VBox, Button,_Fragment, Item, Select) {
    "use strict";

    return Controller.extend("com.mailautomation.controller.Detail", {
        onInit: function () {
        ...
        onSubmit: function () {
            ...
            var oUserName = oView.byId("usernameInput");
                                        ...
                                        oPort.setValueState("None");
                                         if(oConnectionSecurity.getSelectedKey()){
                                            ...
                                            if(oUserName.getValue()){
                                                    ...
                                                    if(oPollingFrequency.getValue()){
                                                        ...
                                                        if(oPollingFrequency.getValue() >= 0){
                                                           ...
                                                           var oContext = oBindList.create({
                                                                ...
                                                                pollingFrequency: oPollingFrequency.getValue(),
                                                                keywords: aKeywords,
                                                                markRead: oMarkRead
                                                ...
                                                oUserName.setValueStateText("username is mandatory");
                                                oUserName.setValueState("Error")
                                            }
                                            }else{
                                                oUserName.setValueStateText("username is mandatory");
                                                oUserName.setValueState("Error")
        ...
        onPressCheckPrevious: function () {
            ...
            if (!oDialog) {
                // Load the fragment
                oDialog = sap.ui.xmlfragment(oView.getId(), "com.mailautomation.fragments.PanelFragment", this);
